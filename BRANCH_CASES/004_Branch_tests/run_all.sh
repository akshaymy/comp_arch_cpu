...
python3 instr_gen.py --instr_format itype --instr_type ADDI --src1 6 --imm_value -5 --dest 6 --imem_file_path jnk.fill
...
python3 instr_gen.py --instr_format branch --instr_type BEQ --src1 8 --src2 9 --imm_value 4 --imem_file_path jnk.fill
python3 instr_gen.py --instr_format itype --instr_type ADDI --src1 9 --imm_value 10 --dest 9 --imem_file_path jnk.fill
python3 instr_gen.py --instr_format itype --instr_type ADDI --src1 9 --imm_value 10 --dest 9 --imem_file_path jnk.fill
python3 instr_gen.py --instr_format itype --instr_type ADDI --src1 9 --imm_value 10 --dest 9 --imem_file_path jnk.fill
